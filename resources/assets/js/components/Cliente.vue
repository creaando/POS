<template>
    <main class="main">
        ...
        <div class="navbar navbar-light bg-success d-flex justify-content-center">
            <h2 class="text-align-center"> <i class="cil-library"></i> Clientes</h2> 
        </div>
                            ...
                            <tr v-for="persona in arrayPersona" :key="persona.id">
                                <td>
                                    ...
                                    <!-- <template v-if="persona.condicion">
                                        <button type="button" class="btn btn-dark btn-sm" @click="desactivarPersona(persona.id)">
...
<!-- ((((((((((((((((======================)))))))))))))))) -->
                            <!-- <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="input-tipoDoc">Tipo De Documento</label>
                                    
                                    <select v-model="tipo_documento" class="form-control custom-select">
                                ...
                                <div class="form-group col">
                                    <label class="col form-control-label" for="text-input">Numero De Documento</label>
                                    <div class="col">
