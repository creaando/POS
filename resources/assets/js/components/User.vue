<template>
    <main class="main">
        ...
        <div class="navbar navbar-light bg-success d-flex justify-content-center">
            <h2 class="text-align-center"> <i class="cil-library"></i> Usuarios</h2>
        </div>
                            ...
                            <tr v-for="persona in arrayPersona" :key="persona.id">
                                <td>
                                    ...
                                    <template v-if="persona.condicion">
                                        <button type="button" class="btn btn-dark btn-sm" @click="desactivarUsuario(persona.id)">
                                            <i class="icon-trash"></i>
                                        </button>
                                    </template>
                                    <template v-else>
                                        <button type="button" class="btn btn-secondary btn-sm" @click="activarUsuario(persona.id)">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="usuario-input">Nombre del usuario (*)</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="usuario-input">Password</label>
                                <div class="col-md-9">
